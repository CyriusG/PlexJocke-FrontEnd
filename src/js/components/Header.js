                ...
                <div className="container">
                    ...
                    <div className={"navbar-collapse " + collapsed} id="navbar">
                        <ul className="nav navbar-nav">
                            ...
                            <li><a target="_blank" href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=E5AM3J7EEY5WL" onClick={this.toggleNavbar.bind(this)}> <i class="fa fa-heart" aria-hidden="true"></i> Donate</a></li>
                        </ul>
